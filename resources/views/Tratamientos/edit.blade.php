...
<head>
    ...
    <style>
        ...
        .container {
            ...
            margin: 50px auto;
            padding: 20px;
            background-color: #fff; /* Fondo del contenedor blanco */
            border-radius: 8px;
...
<body>
    <h1>Editar datos de Tratamiento</h1>
    <div class="container">
        <form action="{{route('Tratamiento.update', $Tratamiento->id)}}" method="POST">
            ...
            <div>
                ...
                <input type="text" id="id" name="id" value="{{$Tratamiento->id}}">
            </div>
            <div>
                <label for="nombre">Nombre:</label>
                <input type="text" id="nombre" name="nombre" value="{{$Tratamiento->nombre}}">
            </div>
            <div>
                <label for="descripcion">Descripcion:</label>
                <input type="text" id="descripcion" name="descripcion" value="{{$Tratamiento->descripcion}}">
            </div>
            <div>
                <label for="precio">Precio:</label>
                <input type="text" id="precio" name="precio" value="{{$Tratamiento->precio}}">
            </div>
